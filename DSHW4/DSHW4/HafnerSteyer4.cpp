...
int main() {
	...
	quickCounter = mergeCounter = insertionCounter = bubbleCounter = 0;
	...
	hybridSort(v, MERGE, INSERTION, 10, 0, v.size() - 1);

	printVector(v);


	cout << endl << "Q:\t" << quickCounter << endl;
	cout << "M:\t" << mergeCounter << endl;
	cout << "I:\t" << insertionCounter << endl;
	cout << "B:\t" << bubbleCounter << endl;
